...
#' results = library_messar2(library2, type = "drug", tops = 5, output = "thermo_substructure.mgf")
#'
...
library_messar2<-function(library, type = c("drug", "metabolite"), tops = 5, max_peaks = 200, min_relative = 0.1, output="library_messar_drug.mgf"){

...
#' @param input_library A list generated by the function library_generator(), must contain "complete", "consensus" and "network"
...
library_similarity<- function(query_spectrum, polarity = "Positive", prec_mz = 100, use.prec = FALSE, input_library = NULL,  
